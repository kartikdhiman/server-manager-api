package com.kartikdhiman.server.service.implementation;
...
import com.kartikdhiman.server.service.ServerService;
...
public class ServerServiceImpl implements ServerService {
	...
	public Server get(long id) {
		...
		Server server = null;
		Optional<Server> fetchedServer = serverRepo.findById(id);
		if (fetchedServer.isPresent()) server = fetchedServer.get();
		return server;
	}
